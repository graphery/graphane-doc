...
```html
<script src="https://cdn.graphery.online/graphane/0.1.0-alpha.2/component/template.js"></script>
```
...
```
https://cdn.graphery.online/graphane/0.1.0-alpha.2/component/template.js
|-----|--------------------|--------|-------------|---------|-----------|
   |            |               |          |           |          |-----> filename
   |            |               |          |           |----------------> kind
   |            |               |          |----------------------------> version

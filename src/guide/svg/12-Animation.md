...
potential problems. We recommend using [Graphane Animation](../in-depth/animation/) functionality
rather than using the native animations directly, although they will always be available for use.

...
**Graphane** includes a flexible API to simplify the construction and manipulation of SVG graphs.
graphics from Javascript. The API is very close to the SVG structure, and is easy to understand if
you know the SVG format.
...
`element.width(100).height(100)`. If you need to obtain the value, you must call to the method 

import{_ as i,c as a,o as n,m as s,a as t,U as l}from"./chunks/framework.DsWckVvh.js";const B=JSON.parse('{"title":"Population Ranking","description":"","frontmatter":{"outline":"deep"},"headers":[],"relativePath":"examples/ranking.md","filePath":"examples/ranking.md"}'),p={name:"examples/ranking.md"},h=s("h1",{id:"population-ranking",tabindex:"-1"},[t("Population Ranking "),s("a",{class:"header-anchor",href:"#population-ranking","aria-label":'Permalink to "Population Ranking"'},"​")],-1),k=s("g-composer",{style:{width:"500px"}},[s("svg",{viewBox:"0 0 500 500"},[s("defs",{"g-for":"({country, population}, n) of data"},[s("g",{"g-bind:transform":`$$.translate(
                             Object.values(
                               $.polar2cartesian(250, 
                                                 250, 
